...
/* 
   ...
   It's 20x or 19x faster with 32 threads and using static scheduling
   ...
   Static seems better than dynamic and
   it got faster as I increased the number of threads until 32.
   Fastest combination was static with 32 threads.
